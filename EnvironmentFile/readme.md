...
CopyBlockLength|The size of the block for each reading and writing while file copying. Integer value.|131072
StreamBufferLength|The size of the stream buffer for disk I/O. Integer value.|131072
